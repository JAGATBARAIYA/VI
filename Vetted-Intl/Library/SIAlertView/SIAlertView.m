...
+ (void)initialize
{
    ...
    appearance.titleFont = [UIFont fontWithName:@"Roboto-Medium" size:20.0];
    appearance.messageFont = [UIFont fontWithName:@"Roboto-Regular" size:15.0];
    appearance.buttonFont = [UIFont fontWithName:@"Roboto-Medium" size:[UIFont buttonFontSize]];
